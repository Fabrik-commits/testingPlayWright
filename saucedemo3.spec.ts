...
/*     const pepito = new LoginPage(page)
    await pepito.fillUserName()
    await pepito.fillPassword()
    ...
    await page.getByRole('textbox', {name:'First Name'}).fill('Fabrik')
    await page.getByRole('textbox', {name:'Last Name'}).fill('Hernandez')
    await page.getByRole('textbox', {name:'Zip/Postal Code'}).fill('2000')
...
/*     const pepito = new LoginPage(page)
    await pepito.fillUserName('problem_user')
